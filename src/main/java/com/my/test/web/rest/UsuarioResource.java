...
import com.my.test.domain.Usuario;
import com.my.test.service.UsuarioService;
...
/**
 * REST controller for managing {@link com.my.test.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
public class UsuarioResource {
    ...
    private static final String ENTITY_NAME = "testUsuario";
